    ...
    var body: some View {
        VStack{
            ...
            for i in 0..<(userFullWork?.userExcersises.workout_plan.count  ?? 1){
                ...
                viewModel.items.append(ExcListItem( title: userFullWork?.userExcersises.workout_plan[i].muscle_group ?? "failed",description: temp, totalCalories: 150, duration: 20, NumExcersises: 4))
                temp=""
